...
public class JavaBaseServiceImplGenerator extends AbstractJavaGenerator {
    ...
    protected void addBasicClass(TopLevelClass topLevelClass) {
        ...
        // 基类
        FullyQualifiedJavaType baseServiceImpl = new FullyQualifiedJavaType("com.strr.base.service.impl.CrudServiceImpl");
        ...
        // 基类方法
        FullyQualifiedJavaType baseMapper = new FullyQualifiedJavaType("com.strr.base.mapper.CrudMapper");
